...
security http profile DDoS_HTTP {
    app-service none
...
security dos profile DDoS_Generic {
    app-service none
    ...
    dos-network {
        DDoS_Generic {
            dynamic-signatures {
                detection enabled
                mitigation medium
                scrubber-category attacked_ips
                scrubber-enable yes
            }
            network-attack-vector {
                ...
                udp-flood {
                    ...
                    auto-scrubbing enabled
                    bad-actor disabled
                    blacklist-category attacker_ips
                    blacklist-detection-seconds 60
                    blacklist-duration 14400
                    ceiling infinite
                    floor 100
    ...
    last-modified-time 2020-01-16:10:50:28
    modify-user admin
    protocol-dns {
        DDoS_Generic {
            dns-query-vector {
                ...
                cname {
                    ...
                    ceiling infinite
                    floor 100
                    per-dst-ip-detection-pps 1000
                    per-dst-ip-limit-pps 500
                    per-source-ip-detection-pps infinite
                    per-source-ip-limit-pps infinite
                    rate-threshold 1000
                    scrubbing-category attacked_ips
